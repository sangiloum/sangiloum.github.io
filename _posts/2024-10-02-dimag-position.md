...
Currently, DIMAG consists of researchers from various countries such as Korea, the USA, Germany, Canada, and France, and the work is done in English. DIMAG is co-located with the [IBS Extremal Combinatorics and Probability Group (ECOPRO)](https://www.ibs.re.kr/ecopro/).
...
4.  [Consent to Collection and Use of Personal Information & Application for the IBS (PDF file)](https://dimag.ibs.re.kr/cms/wp-content/uploads/2024/10/ibs-form-2024-3.pdf)
5.  At least 3 recommendation letters

For full consideration, applicants should email items 1, 2, 3, and 4 and arrange their recommendation letters emailed to dimag@ibs.re.kr by **December 1, 2024**, [Anywhere on Earth (AoE)](https://en.wikipedia.org/wiki/Anywhere_on_Earth).
